    ...
    <body>
         ...
         <div class="container">
           <div class="header clearfix">
                ...
                <h3 class="text-muted">VNPAY BANKING</h3>
            </div>
            <h3>Tạo mới đơn hàng</h3>
            <div class="table-responsive">
                <form action="/Account/vnpayajax" id="frmCreateOrder" method="post">        
                    <div class="form-group">
                        ...
                        <script>
                            document.querySelector(".form-control").value = parseInt(${totalPrice});
                        </script>
                    </div>
