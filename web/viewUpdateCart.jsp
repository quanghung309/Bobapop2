...
<html>
    ...
    <body>
        ...
        <div class="model">
            <div
                class="flex justify-center items-center m-10 h-[540px] product-info"
                >
                ...
                <div class="h-full">
                    <form
                        ...
                        id="form_addcart"
                        >
                        <input name="priceProduct" value="${cartProduct.price}" class="hidden">
                        <input name="cartId" value="${cart.cartId}" class="hidden">
                        <input name="productId" value="${product.product_id}" class="hidden">
                        <input name="cartProductId" value="${cartProduct.product_id}" class="hidden">
                        <!-- name -->
                        <h2 class="font-semibold text-[25px] mb-8">
                            ${cart.productName}
                        </h2>
                        ...
                        <div class="mb-8">
                            <p class="text-lg">
                                <span class="text-red-600">${cart.price}</span> VND
                            </p>
                        </div>
                        <!-- size -->
                        <div class="flex size mb-4">
                            ...
                            <div>
                                <input
                                    ...
                                    value="M"
                                    data-price="49000"
                                    ${cart.size eq "M" ? "checked" : ""}
                                    class="hidden size-input"
                                    />
                                <label class="size-label" for="sizeMU">M</label>
                                <input
                                    type="radio"
                                    id="sizeLU"
                                    name="sizenameU"
                                    value="L"
                                    data-price="55000"
                                    ${cart.size eq "L" ? "checked" : ""}
                                    class="hidden size-input"
                                    />
                                <label class="size-label" for="sizeLU">L</label>
                            </div>
                        </div>
                        <hr class="my-4" />
                        <!-- amount -->
                        <div class="flex my-4">
                            ...
                            <div class="form-group">
                                <div class="input-group flex items-center">
                                    <div class="icon-amount icon-amount-addU">
                                        <i class="fa fa-plus"></i>
                                    </div>
                                    <input
                                        type="text"
                                        ...
                                        readonly="true"
                                        />
                                    <div class="icon-amount icon-amount-minusU">
                                        <i class="fa fa-minus"></i>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        document
                .querySelector(".hidden-icon")
                .addEventListener("click", function () {
                    document.querySelector(".model").classList.add("hidden");
                });
        document
                .querySelector(".icon-amount-addU")
                .addEventListener("click", function () {
                    var input = document.getElementById("quantityU");
                    var currentValue = Number(input.value);
                    input.value = currentValue + 1;
                });
        document
                .querySelector(".icon-amount-minusU")
                .addEventListener("click", function () {
                    var input = document.getElementById("quantityU");
                    var currentValue = Number(input.value);
                    input.value =
