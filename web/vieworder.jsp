                            ...
                            <div class="order-card-price">
                                ...
                                <div class="order-btn">
                                    <c:if test="${o.status eq 'PENDING'}">
                                        <a href="cancelOrder?orderId=${o.orderId}" class="cancelBtn-${o.orderId}">HỦY</a>
                                        <a href="confirmOrder?orderId=${o.orderId}" class="confirmBtn-${o.orderId} hidden">XÁC NHẬN</a>
                                    </c:if>
                                    <a href="orderAgain?orderId=${o.orderId}&totalPrice=${o.totalPrice}">MUA LẠI</a>
                                </div>
